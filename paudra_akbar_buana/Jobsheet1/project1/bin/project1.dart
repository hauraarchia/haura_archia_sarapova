...
void main(List<String> arguments) {
  ...
  */
  ...
  String alamat = "Jl Tenaga Kepuharjo,Karangploso";
  ...
  num nilai = 89.5; // bisa menampung int dan double
  ...
  /*
    ...
    */
      ...
      // list
  List <String> hobby =["Main bola", "Main Valorun", "Main Fifa"];
  hobby.add("Nonton Netflix");
