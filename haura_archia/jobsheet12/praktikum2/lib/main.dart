import 'User.dart'; // Ganti dengan path import yang sesuai
...
void main() {
  ...
  // Debug: Print JSON data structure
  ...
  // Test dengan missing fields ('name' dan 'createdAt' hilang)
  ...
  try {
    ...
    // Karena 'required: true' pada anotasi, ini akan melempar error
